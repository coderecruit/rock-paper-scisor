...
// 1. Make computerPlay return Rock, Paper or Scisor 

let computerPlay = ["Rock", "Paper", "Scisor"];


function computerSelection() {
    return randomItem = computerPlay [Math.floor(Math.random()*computerPlay.length)];
